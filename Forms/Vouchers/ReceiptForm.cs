...
namespace BillingSoftware.Forms.Vouchers
{
    public partial class ReceiptForm : Form
    {
        ...
        private void CreateReceiptFormUI()
        {
            ...
            // Voucher Number
            CreateLabel("Receipt Number:", 20, 40, mainGroup);
            voucherNumberTxt = CreateTextBox(150, 40, 200, mainGroup);
            voucherNumberTxt.Text = voucherManager.GenerateVoucherNumber("Receipt");
        ...
        {
            if (string.IsNullOrWhiteSpace(receivedFromTxt.Text) || string.IsNullOrWhiteSpace(amountTxt.Text))
            {
                MessageBox.Show("Please enter 'Received From' and amount!", "Validation Error", 
            ...
            {
                MessageBox.Show("Receipt voucher saved successfully!", "Success", 
            ...
            {
                MessageBox.Show("Failed to save receipt voucher!", "Error", 
