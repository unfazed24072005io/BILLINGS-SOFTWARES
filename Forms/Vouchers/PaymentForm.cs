...
namespace BillingSoftware.Forms.Vouchers
{
    public partial class PaymentForm : Form
    {
        ...
        private void CreatePaymentFormUI()
        {
            ...
            CreateLabel("Against Purchase:", 20, 160, mainGroup);
            ...
            // Buttons
            saveBtn = CreateButton("Save Payment", Color.FromArgb(46, 204, 113), new Point(20, 440));
        ...
        {
            var purchaseVouchers = voucherManager.GetPurchaseVouchersForReference();
            referenceVoucherCombo.Items.Add("-- Select Purchase Voucher --");
